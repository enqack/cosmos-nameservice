...
func NewMsgCreateWhois(creator string, name string, address string, price string) *MsgCreateWhois {
...
func NewMsgUpdateWhois(creator string, id string, name string, address string, price string) *MsgUpdateWhois {
